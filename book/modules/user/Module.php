...
class Module extends \yii\base\Module
{
    ...
    /**
     * @var array Model classes, e.g., ["User" => "book\modules\user\models\User"]
     * Usage:
     *   $user = Yii::$app->getModule("user")->model("User", $config);
     *   (equivalent to)
     *   $user = new \book\modules\user\models\User($config);
     *
    ...
    protected function checkModuleProperties()
    {
        ...
        if ($userComponent && !$userComponent instanceof \book\modules\user\components\User) {
            throw new InvalidConfigException('Yii::$app->user is not set properly. It needs to extend \book\modules\user\components\User');
        }
    }
    ...
    protected function getDefaultModelClasses()
    {
        ...
        if (Yii::$app->get('user', false)) {
            ...
            $userClass = 'book\modules\user\models\User';
        }

        return [
            'User' => $userClass,
            'Profile' => 'book\modules\user\models\Profile',
            'Role' => 'book\modules\user\models\Role',
            'UserToken' => 'book\modules\user\models\UserToken',
            'UserAuth' => 'book\modules\user\models\UserAuth',
            'ForgotForm' => 'book\modules\user\models\forms\ForgotForm',
            'LoginForm' => 'book\modules\user\models\forms\LoginForm',
            'ResendForm' => 'book\modules\user\models\forms\ResendForm',
            'UserSearch' => 'book\modules\user\models\search\UserSearch',
            'LoginEmailForm' => 'book\modules\user\models\forms\LoginEmailForm',
        ];
    }
