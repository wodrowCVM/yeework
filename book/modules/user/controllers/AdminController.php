...
use Yii;
use book\modules\user\models\User;
use book\modules\user\models\UserToken;
use book\modules\user\models\UserAuth;
...
class AdminController extends Controller
{
    ...
    {
        /** @var \book\modules\user\models\search\UserSearch $searchModel */
