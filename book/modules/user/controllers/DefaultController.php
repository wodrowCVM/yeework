...
namespace book\modules\user\controllers;
...
class DefaultController extends Controller
{
    ...
    {
        /** @var \book\modules\user\models\forms\LoginForm $model */
    ...
    {
        /** @var \book\modules\user\models\forms\LoginEmailForm $loginEmailForm */
    ...
    public function actionLoginCallback($token)
    {
        ...
        /** @var \book\modules\user\models\Role $role */
     ...
     * @param \book\modules\user\models\User $user
     */
    ...
    {
        /** @var \book\modules\user\models\forms\ResendForm $model */
    ...
    {
        /** @var \book\modules\user\models\forms\ForgotForm $model */
