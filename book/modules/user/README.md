...
return [
    'components' => [
        ...
        'user' => [
            'class' => 'book\modules\user\components\User',
        ],
        'mailer' => [
    ...
    'modules' => [
        'user' => [
            'class' => 'book\modules\user\Module',
...
change the namespaces in the files. Replace ```book\modules\user``` with ```app\modules\user```.
