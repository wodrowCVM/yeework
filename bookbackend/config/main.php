...
return [
    ...
    'controllerNamespace' => 'bookbackend\controllers',
    ...
    'components' => [
        ...
        'yee' => [
            'class' => \yeesoft\Yee::className(),
        ],
        'settings' => [
            'class' => \yeesoft\components\Settings::className(),
        ],
        'user' => [
            'class' => \yeesoft\components\User::className(),
